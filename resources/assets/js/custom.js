...
$(document).ready(function () {
  ...
  function callToaster(positionClass) {
    ...
    toastr.success("Welcome to Mousewait Dashboard", "Howdy!");
  }
  ...
  // }
	...
	{
		if(window.location.href == 'http://localhost/mousewaitnew/backend/dashboard')
		{
		callToaster("toast-top-right"); 
		}	
	}
	...
	{
		if(window.location.href == 'https://mousewait.xyz/mousewaitnew/backend/dashboard')
		{
		callToaster("toast-top-right");  
		}
