   ...
   <div class="content">
     <div class="invoice-wrapper rounded border bg-white py-5 px-3 px-md-4 px-lg-5 mb-6">
       ...
       <div class="d-flex">
         ...
         <h3 class="font-weight-bold ml-5 pl-5">Edit Email Template</h3>
       </div>
	 ...
	 <table class="advertise mt-2" width="633" border="0" cellpadding="3" cellspacing="3">
             <!--tr>
               ...
               <td width="424" align="left">
				...
				/* 	   $qry = "SELECT  distinct template_for  FROM `tbl_email_templates`  WHERE status =1 ORDER BY template_for ASC";
					   $ddl_results = DB::select($qry);
						$ddl_template_for = $products->template_for;
						foreach ($ddl_results as $row) 
						{ 
						
							$ddl_template = $row->template_for;  
							if($ddl_template == $ddl_template_for)
							{
								 echo '<option value="'.$ddl_template.'" selected="selected">'.$ddl_template.'</option>'	;	
							}
								else
							{
								 echo '<option value="'.$ddl_template.'">'.$ddl_template.'   </option>'	;		
							} 							
               ...
               <td>Template For :</td>
               <td>
                 <input name="templatefor" id="templatefor" readonly type="text" value="{{ $products->template_for}}" style="width:400px; height:30px" />
               </td>
             </tr>
             <tr>
               <td>Email Subject :</td>
               <td>
                 <input name="tboxsubject" id="tboxsubject" type="text" value="{{ $products->subject}}" style="width:400px; height:30px" />
               </td>
             </tr>
             <tr>
               <td>Template Description:</td>
               <td>
                 <input name="tboxdescription" id="tboxdescription" type="text" value="{{ $products->description}}" style="width:400px; height:30px" />
               </td>
             </tr>
           </table>
           <table class="advertise">
             ...
             <tr>
               <td>
                 <textarea name="tboxtemplate" id="tboxtemplate" class="tboxtemplate ckeditor ">{{ $products->template}}</textarea>
               </td>
               <td class="ck-td"> Following Strings will be replaced in Email Tempalates. <br />
				 ...
				 %REPORT_USER_NAME% &nbsp;&nbsp;&nbsp;(REPORT USER NAME) <br />%REPORT_USER_ID% &nbsp;&nbsp;&nbsp;(REPORT USER ID) <br />%REASON_FOR_REPORT% &nbsp;&nbsp;&nbsp;(REASON FOR REPORT) <br />%USER_IMAGE% &nbsp;&nbsp;&nbsp;(USER IMAGE) <br />%REPORT_USER_LINK% &nbsp;&nbsp;&nbsp;(REPORT USER LINK) <br /> %DELETE% &nbsp;&nbsp;&nbsp;(DELETE) <br />%REMOVE% &nbsp;&nbsp;&nbsp;(REMOVE) <br />%RESTORE% &nbsp;&nbsp;&nbsp;(RESTORE) <br />%MOVEHUB% &nbsp;&nbsp;&nbsp;(MOVE HUB) <br />%MOVESILENT% &nbsp;&nbsp;&nbsp;(MOVE SILENT) <br />%DM% &nbsp;&nbsp;&nbsp;(DM) <br />
               </td>
             </tr>
             <tr>
