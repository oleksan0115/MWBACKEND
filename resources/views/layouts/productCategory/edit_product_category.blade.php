   ...
   <div class="content">
     <div class="invoice-wrapper rounded border bg-white py-5 px-3 px-md-4 px-lg-5 mb-6">
       ...
       <div class="d-flex">
         ...
         <h3 class="font-weight-bold ml-5 pl-5">Edit Category</h3>
       </div>
       <div class="row pt-5">
         <form action="" method="POST" enctype="multipart/form-data" class="product_table"> @csrf <table width="633" border="0" cellpadding="3" cellspacing="3">
             ...
             <tr>
               ...
               <td width="458" align="left" valign="top">
                 <input name="txt_cat_name" id="txt_cat_name" type="text" value="{{ $products->emoji_category_name}}" class="input_textbox" />
               </td>
             </tr>
             <tr>
               ...
               <td width="458" valign="top" align="left">
                 <textarea name="txt_cat_desc" id="txt_cat_desc" cols="50" rows="5">{{ $products->description}}</textarea>
               </td>
             </tr>
             <tr>
               ...
               <td width="458" height="30" valign="top" align="left">
                 <input name="myfile" id="myfile" type="file"  onchange="readURL(this)" style="margin-bottom:1rem" />
				  <img id="img-preview" width="50px" src="/disneyland/images/products_thumbnail/{{ $products->enoji_image}}" />
               </td>
             </tr>
             <tr>
