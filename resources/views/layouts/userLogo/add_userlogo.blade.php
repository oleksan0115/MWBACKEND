   ...
   <div class="content">
	 ...
	 @if(session()->has('message')) <div class="alert alert-success">
       ...
       <div class="d-flex">
         ...
         <h3 class="font-weight-bold ml-5 pl-5">Add Special Users Logos</h3>
       </div>
       <div class="row pt-5">
         <form action="{{ route('backend.add_userlogo') }}" method="POST" enctype="multipart/form-data" class="product_table"> @csrf <table width="633" border="0" cellpadding="3" cellspacing="3">
             <tr>
