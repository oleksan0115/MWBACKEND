   ...
   <div class="content">
     <div class="invoice-wrapper rounded border bg-white py-5 px-3 px-md-4 px-lg-5 mb-6">
       ...
       <div class="d-flex">
         ...
         <h3 class="font-weight-bold ml-5 pl-5">Edit Credit Sale</h3>
       </div>
    ...
    <div class="col-6 col-md-10"><input required name="tbox_no_of_time" type="text" value="{{ $credit->no_of_times }}" class="input_textbox">
    ...
    <div class="col-6 col-md-2">From Date:</div>
	 ...
	 <div class="col-6 col-md-10"><input required type="text" value="{{ $credit->start_date }}" id="from_datetime" name="from_datetime">
	</div>
	...
	<div class="col-6 col-md-10"><input required type="text" value="{{ $credit->end_date }}" id="end_datetime" name="end_datetime">
	</div>
    ...
    <div class="col-6 col-md-10"><input required id="chk_status" name="chk_status" type="checkbox" value="1"
	@if($credit->status) checked @endif 
	></div>
	...
	<div class="row mb-5">
		...
		<input id="hidden_id" name="hidden_id" type="hidden" value="{{ $credit->id }}">
