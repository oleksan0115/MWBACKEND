...
@endif
				<div class="d-flex justify-content-between">
					...
					<h3 class="font-weight-bold ml-5 pl-5">Add Product</h3>
					</div>
						<div class="row pt-5">
  ...
  <tr>
    <td align="center" class="page_heading_gray"></td>
				...
				<td width="1"></td>
				<td width="458" align="left" valign="top"><input name="tboxproductName" id="tboxproductName" type="text" value=""  class="input_textbox"  />		
				</td>
				   ...
				   <tr>
							...
							<td width="458" valign="top" align="left">
							  <textarea name="tAreaproductDesc" id="tAreaproductDesc" cols="50" rows="5"></textarea>		
							</td>  
						</tr>
						  ...
						  <td width="1"></td>
						  <td valign="top" align="left"><input name="tboxProductQty" id="tboxProductQty" type="text" value=""  class="input_textbox"/></td>
					  </tr>
					  
					  <tr>
						  <td align="left" valign="top" class="left_lable text-dark">&nbsp;&nbsp;Price</td>
						  <td></td>
						  <td valign="top" align="left"><input name="tboxproductPrice" id="tboxproductPrice" type="text" value=""  class="input_textbox"/></td>
					  </tr>
					 ...
					 <tr>
						  ...
						  <td></td>
						  <td valign="top" align="left"><input id="chkowner" name="chkowner" type="checkbox" value="1"  />&nbsp;&nbsp;Owner Only</td>
					  </tr>
                     <tr>
						  <td align="left" valign="top" class="left_lable"></td>
						  <td></td>
						  <td valign="top" align="left"><input id="chkstatus" name="chkstatus" type="checkbox" value="1"  />&nbsp;&nbsp;Active</td>
					  </tr>
                     <tr>
						  <td align="left" valign="top" class="left_lable"></td>
						  <td></td>
						  <td  valign="top" align="left"><input id="chkemojis" name="chkemojis" type="checkbox" value="1"  />&nbsp;&nbsp;Isemojis</td>
					  </tr>  
					   ...
					   <tr>
                         ...
                         @foreach($emoji as $row)
                          <option value="{{ $row->id}}" >{{ $row->emoji_category_name}}</option>
						  @endforeach
                          </select>
                          </td>
					  </tr> 
					  ...
					  <tr>
                        ...
                        <tr>
						  ...
						  <td></td>
						  <td valign="top" align="left"><input id="chkisauction" name="chkisauction" type="checkbox" value="1" />&nbsp;&nbsp;auction</td>
					  </tr>    
                     ...
                     <tr>
						  ...
						  <td></td>
						  <td valign="top" align="left">
						  <input name="tboxstartdate" id="tboxstartdate" type="text" value="{{ date('Y-m-d H:i') }}"  class="input_textbox text-dark" style="margin-top:1rem"/> format: "< 2013-10-05 23:59 >"
						  </td>
					  </tr>
                      <tr>
						  <td align="left" valign="top" class="left_lable text-dark">&nbsp;&nbsp;auction End Date</td>
						  <td></td>
						  <td valign="top" align="left"><input name="tboxenddate" id="tboxenddate" type="text" value="{{ date('Y-m-d H:i') }}"  class="input_textbox text-dark"/>  format: "< 2013-10-05 23:59 >"</td>
					  </tr>
                     <tr>
						  <td align="left" valign="top" class="left_lable text-dark">&nbsp;&nbsp;Intial Bid</td>
						  <td></td>
						  <td valign="top" align="left"><input name="tboxinitialcredits" id="tboxinitialcredits" type="text" value=""  class="input_textbox"/></td>
					  </tr> 
					  ...
					  <tr>
					   ...
					   <tr>
						  ...
						  <td></td>
						  <td valign="top" align="left"><input name="tbox_active_datetime" id="tbox_active_datetime" type="text" value="{{ date('Y-m-d H:i') }}"  class="input_textbox"/> format: "< 2013-10-05 23:59 >"</td>
					  </tr>
                        
		    	<tr>
				<td valign="top" align="center">
			    <input type="hidden" name="hdd_product_id" id="hdd_product_id" value="" />
