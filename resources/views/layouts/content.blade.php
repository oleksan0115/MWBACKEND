          ...
          <div class="content">                
                ...
                <div class="row">
                  ...
                  <div class="col-xl-4">
                    ...
                    <div class="card card-default">
                      <div class="card-header">
                        <h2 class="font-weight-bold">Last 30 Days Statistics:</h2>
                      </div>
                      <div class="card-body">
                    ...
                    <div class="card card-default">
                      ...
                      <div class="card-body">
						<a href="{{ env('APP_URL') }}users"><button type="button" class="btn btn-sm btn-primary"><i class="mdi mdi-account"></i>&nbsp; Credit User</button></a>
						
						<a href="{{ env('APP_URL') }}productAdd"><button type="button" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i>&nbsp; Add Sticker</button></a>
						
						<a href="{{ env('APP_URL') }}userCreditSetting"><button type="button" class="btn btn-sm btn-primary"><i class="fa-solid fa-check"></i>&nbsp;Adjust Credit Sale</button></a>
                     
						<a href="{{URL::to('/userLogo')}}"><button type="button" class="btn btn-sm btn-primary"><i class="mdi mdi-account-check"></i>&nbsp;Assign Logo TO User</button></a>
						
						<a  href="{{URL::to('/right')}}"><button type="button" class="btn btn-sm btn-primary mt-2"><i class="mdi mdi-check-all"></i>&nbsp;User Rights</button></a>
						
						<a  href="{{URL::to('/getUserPermissionMenu')}}"><button type="button" class="btn btn-sm btn-primary mt-2"><i class="mdi mdi-check-all"></i>&nbsp;User Permission</button></a>
						
						<a  href="{{URL::to('/tag')}}"><button type="button" class="btn btn-sm btn-primary mt-2"><i class="mdi mdi-more"></i>&nbsp;Tag</button></a>
						
						<a  href="{{URL::to('/advertisePost')}}"><button type="button" class="btn btn-sm btn-primary mt-2"><i class="mdi mdi-checkbox-multiple-marked-outline"></i>&nbsp;Advertise Post</button></a>
						
						
						<a  href="{{URL::to('/song')}}"><button type="button" class="btn btn-sm btn-primary mt-2"><i class="fa fa-volume-up" aria-hidden="true"></i>&nbsp;Manage Songs</button></a>
						
						<a  href="{{URL::to('/news')}}"><button type="button" class="btn btn-sm btn-primary mt-2"><i class="fa fa-newspaper" aria-hidden="true"></i>&nbsp;News</button></a>	
						
						<a  href="{{URL::to('/bestofthedayemail')}}"><button type="button" class="btn btn-sm btn-primary mt-2"><i class="fa fa-newspaper" aria-hidden="true"></i>&nbsp;Best Of The Day Email</button></a>
						
						<a  href="{{URL::to('/userCreditSetting')}}"><button type="button" class="btn btn-sm btn-primary mt-2"><i class="fa fa-credit-card" aria-hidden="true"></i>&nbsp;User Credit Setting</button></a>
						<a  href="{{URL::to('/emailTemplate')}}"><button type="button" class="btn btn-sm btn-primary mt-2"><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;Email Template</button></a>
                      </div>
                     </div>
                  </div>
                    ...
                    <div class="card card-default">
                      ...
                      <div class="card-body py-0" >
                        <div class="row pb-4">
                          ...
                          <div class="col-lg-12">
                            <div class="chart-wrapper">
                              <div id="horizontal-bar-chart-mousewait"></div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="card-body">
                        <table id="productsTable" class="table table-hover table-product" style="width:100%">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="resources/assets/images/products/products-xs-01.jpg" alt="Product Image">
                              </td>
                              <td>Coach Swagger</td>
                              <td>24541</td>
                              <td>27</td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="resources/assets/images/products/products-xs-02.jpg" alt="Product Image">
                              </td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="resources/assets/images/products/products-xs-03.jpg" alt="Product Image">
                              </td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="resources/assets/images/products/products-xs-04.jpg" alt="Product Image">
                              </td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="resources/assets/images/products/products-xs-05.jpg" alt="Product Image">
                              </td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="resources/assets/images/products/products-xs-06.jpg" alt="Product Image">
                              </td>
                              <td>Olay</td>
                              <td>24546</td>
                              <td>19</td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="resources/assets/images/products/products-xs-07.jpg" alt="Product Image">
                              </td>
                              <td>Ledger Nano X</td>
                              <td>24547</td>
                              <td>61</td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="resources/assets/images/products/products-xs-08.jpg" alt="Product Image">
                              </td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="resources/assets/images/products/products-xs-09.jpg" alt="Product Image">
                              </td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="resources/assets/images/products/products-xs-10.jpg" alt="Product Image">
                              </td>
                              <td>Wattbike Atom</td>
                              <td>24550</td>
                              <td>61</td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="resources/assets/images/products/products-xs-11.jpg" alt="Product Image">
                              </td>
                              <td>Smart Watch</td>
                              <td>24551</td>
                              <td>19</td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="resources/assets/images/products/products-xs-12.jpg" alt="Product Image">
                              </td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="resources/assets/images/products/products-xs-13.jpg" alt="Product Image">
                              </td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="resources/assets/images/products/products-xs-14.jpg" alt="Product Image">
                              </td>
                            ...
                            <tr>
                              <td class="py-0">
                                <img src="resources/assets/images/products/products-xs-15.jpg" alt="Product Image">
                              </td>
                              <td>Headphones</td>
                              <td>24555</td>
                              <td>17</td>
                      ...
                      <div class="card card-default chat">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                              <li>
                                <a href="#" class="user-link">
                                  <img src="resources/assets/images/user/user-sm-01.jpg" alt="User Image">
                              ...
                              <li>
                                <a href="#" class="user-link">
                                  <img src="resources/assets/images/user/user-sm-02.jpg" alt="User Image">
                              ...
                              <li>
                                <a href="#" class="user-link">
                                  <img src="resources/assets/images/user/user-sm-03.jpg" alt="User Image">
                                  <span class="username">riman Ghose
                                    <span class="badge badge-secondary">18</span>
                                  </span>
                                  <span class="state">
                              ...
                              <li>
                                <a href="#" class="user-link">
                                  <img src="resources/assets/images/user/user-sm-04.jpg" alt="User Image">
                                  <span class="username">riman Ghose
                                    <span class="badge badge-secondary">18</span>
                                  </span>
                                  <span class="state">
                              ...
                              <li>
                                <a href="#" class="user-link">
                                  <img src="resources/assets/images/user/user-sm-05.jpg" alt="User Image">
                        ...
                        <div class="card-body pb-0" data-simplebar style="height: 363px;">
                          ...
                          <div class="media media-chat">
                            <img src="resources/assets/images/user/user-sm-01.jpg" class="rounded-circle" alt="Avata Image">
                          ...
                          <div class="media media-chat media-chat-right">
                            ...
                            <img src="resources/assets/images/user/user-sm-02.jpg" class="rounded-circle" alt="Avata Image">
                          </div>
